...
(* [aes key iv msg] is [msg] encrypted with aes-256 in CBC mode with [iv] as the
 * iv and [key] as the encryption key. For security [key] should have been 
 * stretched with a memory-hard key derivation function. *)
